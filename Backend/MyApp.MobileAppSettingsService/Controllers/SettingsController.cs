...
using MyApp.MobileAppSettingsService.Auth;
using MyApp.MobileAppSettingsService.Data;
using MyApp.MobileAppSettingsService.DTOs;
using MyApp.MobileAppSettingsService.Models;

namespace MyApp.MobileAppSettingsService.Controllers;
...
public class SettingsController(SettingsDbContext db, ICurrentUserContext user) : ControllerBase
{
    ...
    public async Task<IActionResult> PatchHiddenAccounts(
        [FromBody] UpdateHiddenAccountsDto dto,
