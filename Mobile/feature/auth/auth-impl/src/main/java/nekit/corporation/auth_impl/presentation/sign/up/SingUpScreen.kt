...
@Composable
internal fun SingUpScreen(state: AuthState.SignUpState, signUpInteract: SignUpInteract) {
    /*LazyColumn(
        modifier = Modifier
    ...
    PrimaryInputField(
        ...
        onValueChange = signUpInteract::onEmailChange,
        modifier = Modifier
            .fillMaxWidth(),
    ...
    PrimaryInputField(
        ...
        onValueChange = signUpInteract::onFirstNameChange,
        modifier = Modifier
            .fillMaxWidth(),
    ...
    PrimaryInputField(
        ...
        onValueChange = signUpInteract::onLastNameChange,
        modifier = Modifier
            .fillMaxWidth(),
    ...
    PrimaryInputField(
        ...
        onValueChange = signUpInteract::onPhoneChange,
        modifier = Modifier
            .fillMaxWidth(),
