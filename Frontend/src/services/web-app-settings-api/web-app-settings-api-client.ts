...
export * from './web-app-settings-api-client.types';
...
export * as Client from './web-app-settings-api-client/Client';

export * as Query from './web-app-settings-api-client/Query';





import { addResultTypeFactory } from './web-app-settings-api-client/helpers';
export { setBaseUrl, getBaseUrl } from './web-app-settings-api-client/helpers';
export { setAxiosFactory, getAxios } from './web-app-settings-api-client/helpers';


//-----PersistorHydrator.File-----
import type { PersistedClient } from '@tanstack/react-query-persist-client';
import type { DehydratedState, QueryKey } from '@tanstack/react-query'
import { getResultTypeFactory } from './web-app-settings-api-client/helpers';
...
export function initPersister() {
  ...
  addResultTypeFactory('Client___settingsGET', (data: any) => Types.initUserSettingsDto(data));
  addResultTypeFactory('Client___settingsGET2', (data: any) => Types.initUserSettingsDto(data));
