...
export * from './core-api-client.types';
...
export * as Client from './core-api-client/Client';

export * as Query from './core-api-client/Query';





import { addResultTypeFactory } from './core-api-client/helpers';
export { setBaseUrl, getBaseUrl } from './core-api-client/helpers';
export { setAxiosFactory, getAxios } from './core-api-client/helpers';


//-----PersistorHydrator.File-----
import type { PersistedClient } from '@tanstack/react-query-persist-client';
import type { DehydratedState, QueryKey } from '@tanstack/react-query'
import { getResultTypeFactory } from './core-api-client/helpers';
...
export function initPersister() {
  ...
  addResultTypeFactory('Client___accountsAll', (data: any) => Types.initAccountResponse(data));
  addResultTypeFactory('Client___accountsGET', (data: any) => Types.initAccountResponse(data));
  addResultTypeFactory('Client___transactions', (data: any) => Types.initPagedResponseOfTransactionResponse(data));
